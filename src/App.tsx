import { ProjectPreviewList, ProjectPreviewItem } from "./components/ProjectPreview";
import { SocialContainer, SocialItem } from "./components/SocialLinks";
import "./CSS/App.css";
  ...
  return (
    <div className="PageContainer">
      <div className="SocialDivContainer">
        ...
        <SocialContainer pageLink="#" pageName="ABOUT ME">
      ...
      <div className="ProjectDivContainer">
        ...
        <p className="HeadingText" id="Subtitle">Some projects I've worked on. You can view all of them <a href="#">{"-->here.<--"}</a></p>
        <ProjectPreviewList>
